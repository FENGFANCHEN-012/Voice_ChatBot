...
# this will be triggered only when the first retrieval stage fails, then will use self RAG to verify the relevance of the retrieved chunks and the answer generated by LLM
class SelfRAG:
    ...
    def _call(self, prompt: str) -> str:
        ...
        # only retry on quota exceeded error, otherwise raise the exception
